...
public class AuthControllerTest {
    ...
    public void testPasswordReset() {
        ...
        ResponseEntity<Void> responseEntity = restTemplate
                .exchange("/auth/resetPassword", HttpMethod.POST, new HttpEntity<>(request), Void.class);
    ...
    public void testPasswordUpdate() {
        HttpHeaders headers = LoginUtil.login(Constants.PERA_EMAIL, Constants.PERA_PASSWORD, restTemplate);

        PasswordUpdateRequest request = new PasswordUpdateRequest();
        request.setEmail(Constants.PERA_EMAIL);
        request.setCurrentPassword(Constants.PERA_PASSWORD);
        request.setPassword("cGVyYTEyMzQ=");
        request.setPasswordConfirmation("cGVyYTEyMzQ=");

        HttpEntity<PasswordUpdateRequest> entity = new HttpEntity<>(request, headers);

        ResponseEntity<Void> responseEntity = restTemplate
                .exchange("/auth/updatePassword", HttpMethod.POST, entity, Void.class);
