...
import { UserBasicInfo, UserDTO, UserUpdateRequest } from 'src/models/user/user';
...
export class ProfilePageComponent implements OnInit {
  ...
  setMyProfile() {
    this.userService.getProfile(this.loggedUser?.id as string).subscribe({
  ...
  handleSave(): void {
    ...
    this.userService
      .updateProfile(this.loggedUser?.id as string, this.request as UserUpdateRequest).subscribe({
